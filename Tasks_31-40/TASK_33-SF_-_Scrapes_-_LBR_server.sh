...
TASK 33 - SupportFile - Scrapes for LBR server
...
curl: (7) Failed to connect to localhost port 8095: Connection refused
[loki@stlb01 ~]$
[loki@stlb01 ~]$
[loki@stlb01 ~]$ curl stapp01:8095
<html>
